...
VALUES
    (1, 'João', 'Rua A, 123 São Paulo', '(11) 1234-5678'),
    (2, 'Cleber', 'Avenida B, 456 Rio de Janeiro', '(21) 2345-6789'),
    (3, 'Maicom', 'Travessa C, 789 Belo Horizonte', '(31) 3456-7890'),
    (4, 'Geraldo', 'Rua D, 234 Porto Alegre', '(51) 4567-8901'),
    (5, 'Sidney', 'Avenida E, 567 Salvador', '(71) 5678-9012'),
    (6, 'Cleitom', 'Travessa F, 890 Brasília', '(61) 6789-0123'),
    (7, 'Mariana', 'Rua G, 123 Curitiba', '(41) 7890-1234'),
    (8, 'Barbara', 'Avenida H, 234 Fortaleza', '(85) 8901-2345'),
    (9, 'Cleudes', 'Travessa I, 567 Recife', '(81) 9012-3456'),
    (10, 'Avanir', 'Rua J, 890 Manaus', '(92) 0123-4567');
...
VALUES
    ...
    (3, 'Coxinha', 'Salgado', 1.99, 60, 1, 5),
    (4, 'Rosquinha', 'Rosquinha doce', 0.99, 120, 1, 6),
    (5, 'Bolo de Cenoura', 'Bolo caseiro', 4.99, 40, 1, 10),
    (6, 'Pão de Forma', 'Pão de forma integral', 3.49, 90, 1, 1),
    (7, 'Bolo de Chocolate', 'Bolo Caseiro', 4.99, 50, 1, 4),
    (8, 'Biscoito', 'Pacote de biscoitos sortidas', 2.29, 150, 1, 2),
